...
import com.jotangi.nantoupass.ParkingInfoBottomSheet
import com.jotangi.nantoupass.R
import com.jotangi.nantoupass.databinding.FragmentMapChargeParking2Binding
import com.jotangi.nantoupass.databinding.FragmentMapProjectBinding
 ...
 * Use the [MapProjectFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
open class MapProjectFragment : BaseWithBottomBarFragment(), JMapCharge2.MarkerDialogCallback, JMapCharge3.MarkerDialogCallback2 {
    private var _binding: FragmentMapProjectBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMapProjectBinding.inflate(inflater, container, false)

        val view: View = inflater.inflate(R.layout.fragment_map_project, container, false)
        myview = view
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // feet button
        initEvent()
        setupMapProjectTitle()
//        mapChargeParkingTitle()

        var btBack: ImageButton = view.findViewById<ImageButton>(R.id.bt_back)
        btBack.setOnClickListener {
            findNavController().navigate(R.id.action_mapProjectFragment_to_main_fragment)
        }
